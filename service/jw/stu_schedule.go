...
// QuerySchedule 通过学生正选结果获取课表
func QuerySchedule(cookies []*http.Cookie) (string, error) {
	client := &http.Client{}

	r, _ := http.NewRequest(http.MethodGet, STUZXJGURL, nil)
	...
	r.Header.Add("Referer", STUZXJGURL)
